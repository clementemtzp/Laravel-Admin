...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg"><b>STM</b>Manager</span>
    </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-footer">
                                <a href="{{ url('/logout') }}" class="btn btn-default btn-flat" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Cerrar sesion</a>
